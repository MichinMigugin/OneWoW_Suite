...
OneWoW.Locale:Register(ADDON_NAME, "koKR", {
    ...
    ["VENDORS_WAYPOINT"] = "핀",
    ["VENDORS_WAYPOINT_TT"] = "이 상인 위치에 실시간 경유지를 설정합니다. 세계 지도를 해당 지역으로 엽니다. 도착하면 경유지가 지워집니다. 일부 지도는 실시간 경유지를 허용하지 않습니다.",
    ["VENDORS_WAYPOINT_FAILED"] = "이 지도는 실시간 경유지를 허용하지 않습니다.",
    ["VENDORS_SAVE_WAYPIN"] = "핀 저장",
    ["VENDORS_SAVE_WAYPIN_TT"] = "이 상인의 OneWay Pin을 저장합니다. 핀은 삭제할 때까지 세계 지도와 미니맵에 남습니다.",
    ["VENDORS_OPEN_WAYPIN"] = "핀 열기",
    ["VENDORS_OPEN_WAYPIN_TT"] = "Notes에서 이 상인의 OneWay Pin을 엽니다.",
