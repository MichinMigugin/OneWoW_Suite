...
OneWoW.Locale:Register(ADDON_NAME, "koKR", {
    ...
    ["JOURNAL_TYPE_RAIDS"] = "공격대",
    ["JOURNAL_TYPE_DUNGEONS"] = "던전",
    ...
    ["JOURNAL_FILTER_MOUNTS"] = "탈것",
    ["JOURNAL_FILTER_PETS"] = "애완동물",
    ["JOURNAL_FILTER_RECIPES"] = "도안",
    ["JOURNAL_FILTER_TOYS"] = "장난감",
    ["JOURNAL_FILTER_QUEST"] = "퀘스트 아이템",
    ["JOURNAL_FILTER_HOUSING"] = "주거",
    ["JOURNAL_FILTER_COLLECTED"] = "획득한 것만",
    ["JOURNAL_FILTER_NOT_COLLECTED"] = "미획득만",
    ["JOURNAL_FILTER_RESET"] = "초기화",
    ["JOURNAL_FILTER_N_SELECTED"] = "%d개 선택",

    ["JOURNAL_CARD_RAID"] = "공격대",
    ["JOURNAL_CARD_DUNGEON"] = "던전",
    ["JOURNAL_CARD_ENCOUNTERS"] = "보스 %d명",
    ["JOURNAL_CARD_ITEMS"] = "아이템 %d개",
    ["JOURNAL_CARD_MOUNTS"] = "탈것",
    ["JOURNAL_CARD_PETS"] = "애완동물",
    ["JOURNAL_CARD_RECIPES"] = "도안",
    ["JOURNAL_CARD_TOYS"] = "장난감",
    ["JOURNAL_CARD_QUEST"] = "퀘스트",
    ["JOURNAL_CARD_HOUSING"] = "주거",

    ["JOURNAL_DETAIL_INST_ID"] = "인스턴스 ID",
    ["JOURNAL_DETAIL_MAP_ID"] = "지도 ID",
    ["JOURNAL_DETAIL_TYPE"] = "유형",
    ["JOURNAL_DETAIL_EXPANSION"] = "확장팩",

    ["JOURNAL_COLLECTIONS"] = "수집",
    ["JOURNAL_COL_TMOG"] = "형상변환: %d/%d",
    ["JOURNAL_COL_MOUNTS"] = "탈것: %d/%d",
    ["JOURNAL_COL_PETS"] = "애완동물: %d/%d",
    ["JOURNAL_COL_RECIPES"] = "도안: %d/%d",
    ["JOURNAL_COL_TOYS"] = "장난감: %d/%d",
    ...
    ["JOURNAL_COL_HDR_TYPE"] = "유형",
    ["JOURNAL_COL_HDR_DIFFICULTY"] = "난이도",
    ["JOURNAL_COL_HDR_SPECIAL"] = "특수",
    ["JOURNAL_COL_HDR_STATUS"] = "상태",
    ...
    ["JOURNAL_STATUS_COLLECTED"] = "획득함",
    ["JOURNAL_STATUS_NOT_COLLECTED"] = "미획득",
    ...
    ["QUESTS_NO_DATA"] = "퀘스트 데이터를 수집하려면 OneWoW CatalogData: Quests를 설치하세요.",
    ...
    ["QUESTS_STATUS_CAPPED"] = "%d / %d개 표시 중 - 더 보려면 검색하거나 필터를 사용하세요",
    ...
    ["QUESTS_MAPID"] = "지도 ID",
    ["QUESTS_TYPE_LABEL"] = "유형",
    ["QUESTS_GROUP_TYPE"] = "그룹",
    ["QUESTS_REWARDS"] = "보상",
    ["QUESTS_COMPLETION"] = "완료",
    ["QUESTS_UNKNOWN"] = "알 수 없음",
    ["QUESTS_GOLD"] = "골드",
    ["QUESTS_XP"] = "경험치",
    ["QUESTS_ITEMS"] = "아이템",
    ["QUESTS_OBJECTIVES"] = "목표",
    ["QUESTS_TYPE_DAILY"] = "일일",
    ["QUESTS_TYPE_WEEKLY"] = "주간",
    ...
    ["QUESTS_TYPE_SOLO"] = "솔로",
    ["QUESTS_TYPE_GROUP"] = "파티",
    ["QUESTS_TYPE_RAID"] = "공격대",
    ...
    ["SETTINGS_DB_NAME_VENDORS"] = "상인 데이터",
