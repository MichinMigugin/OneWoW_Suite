...
function ns.UI.CreateTradeskillsTab(parent)
    ...
    ns.UI.OpenTradeskillSearch = function(query, professionName)
        ...
        C_Timer.After(0.15, function()
            ...
            if addon and professionName and professionName ~= "" then
                local professions = addon.TradeskillData:GetProfessions()
                for _, prof in ipairs(professions) do
