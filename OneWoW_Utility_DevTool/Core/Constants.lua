...
Addon.Constants = {
    ...
    THEMES = {
        ...
        blue = {
            name = "Ocean Blue",
            BG_PRIMARY     = { 0.09, 0.11, 0.15, 0.97 },
            BG_SECONDARY   = { 0.06, 0.08, 0.11, 0.95 },
            BG_TERTIARY    = { 0.12, 0.16, 0.22, 1.0 },
            BG_HOVER       = { 0.14, 0.20, 0.28, 1.0 },
            BG_ACTIVE      = { 0.12, 0.22, 0.32, 1.0 },
            ACCENT_PRIMARY   = { 0.35, 0.55, 0.80, 1.0 },
            ACCENT_SECONDARY = { 0.28, 0.45, 0.65, 1.0 },
            ACCENT_HIGHLIGHT = { 0.45, 0.68, 0.95, 1.0 },
            ACCENT_MUTED     = { 0.25, 0.40, 0.58, 0.8 },
            TEXT_PRIMARY   = { 0.88, 0.90, 0.92, 1.0 },
            TEXT_SECONDARY = { 0.62, 0.70, 0.78, 1.0 },
            TEXT_MUTED     = { 0.65, 0.70, 0.75, 1.0 },
            TEXT_ACCENT    = { 0.55, 0.75, 0.95, 1.0 },
            BORDER_DEFAULT = { 0.25, 0.35, 0.45, 0.5 },
            BORDER_SUBTLE  = { 0.20, 0.28, 0.38, 0.3 },
            BORDER_FOCUS   = { 0.40, 0.55, 0.75, 0.7 },
            BORDER_ACCENT  = { 0.35, 0.50, 0.70, 0.6 },
            TITLEBAR_BG    = { 0.12, 0.16, 0.22, 0.98 },
            TITLEBAR_BORDER = { 0.30, 0.40, 0.55, 0.6 },
            BTN_NORMAL     = { 0.14, 0.18, 0.24, 1.0 },
            BTN_HOVER      = { 0.18, 0.26, 0.38, 1.0 },
            BTN_PRESSED    = { 0.12, 0.20, 0.32, 1.0 },
            BTN_BORDER     = { 0.32, 0.45, 0.60, 0.5 },
            BTN_BORDER_HOVER = { 0.40, 0.58, 0.78, 0.7 },
        },
        purple = {
            name = "Mystic Purple",
            BG_PRIMARY     = { 0.11, 0.09, 0.14, 0.97 },
            BG_SECONDARY   = { 0.08, 0.06, 0.10, 0.95 },
            BG_TERTIARY    = { 0.16, 0.12, 0.22, 1.0 },
            BG_HOVER       = { 0.20, 0.14, 0.28, 1.0 },
            BG_ACTIVE      = { 0.22, 0.12, 0.32, 1.0 },
            ACCENT_PRIMARY   = { 0.65, 0.40, 0.85, 1.0 },
            ACCENT_SECONDARY = { 0.52, 0.28, 0.68, 1.0 },
            ACCENT_HIGHLIGHT = { 0.78, 0.50, 0.98, 1.0 },
            ACCENT_MUTED     = { 0.42, 0.25, 0.55, 0.8 },
            TEXT_PRIMARY   = { 0.90, 0.88, 0.92, 1.0 },
            TEXT_SECONDARY = { 0.70, 0.62, 0.78, 1.0 },
            TEXT_MUTED     = { 0.70, 0.63, 0.75, 1.0 },
            TEXT_ACCENT    = { 0.85, 0.55, 1.00, 1.0 },
            BORDER_DEFAULT = { 0.35, 0.25, 0.45, 0.5 },
            BORDER_SUBTLE  = { 0.28, 0.20, 0.38, 0.3 },
            BORDER_FOCUS   = { 0.55, 0.40, 0.75, 0.7 },
            BORDER_ACCENT  = { 0.50, 0.35, 0.70, 0.6 },
            TITLEBAR_BG    = { 0.16, 0.12, 0.22, 0.98 },
            TITLEBAR_BORDER = { 0.40, 0.30, 0.55, 0.6 },
            BTN_NORMAL     = { 0.18, 0.14, 0.24, 1.0 },
            BTN_HOVER      = { 0.26, 0.18, 0.38, 1.0 },
            BTN_PRESSED    = { 0.20, 0.12, 0.32, 1.0 },
            BTN_BORDER     = { 0.48, 0.32, 0.60, 0.5 },
            BTN_BORDER_HOVER = { 0.62, 0.40, 0.78, 0.7 },
        },
        red = {
            name = "Crimson Red",
            BG_PRIMARY     = { 0.15, 0.09, 0.09, 0.97 },
            BG_SECONDARY   = { 0.11, 0.06, 0.06, 0.95 },
            BG_TERTIARY    = { 0.22, 0.12, 0.12, 1.0 },
            BG_HOVER       = { 0.28, 0.14, 0.14, 1.0 },
            BG_ACTIVE      = { 0.32, 0.12, 0.12, 1.0 },
            ACCENT_PRIMARY   = { 0.85, 0.35, 0.40, 1.0 },
            ACCENT_SECONDARY = { 0.68, 0.28, 0.32, 1.0 },
            ACCENT_HIGHLIGHT = { 0.98, 0.45, 0.50, 1.0 },
            ACCENT_MUTED     = { 0.55, 0.25, 0.28, 0.8 },
            TEXT_PRIMARY   = { 0.92, 0.88, 0.88, 1.0 },
            TEXT_SECONDARY = { 0.78, 0.62, 0.62, 1.0 },
            TEXT_MUTED     = { 0.73, 0.63, 0.63, 1.0 },
            TEXT_ACCENT    = { 1.00, 0.55, 0.60, 1.0 },
            BORDER_DEFAULT = { 0.45, 0.25, 0.25, 0.5 },
            BORDER_SUBTLE  = { 0.38, 0.20, 0.20, 0.3 },
            BORDER_FOCUS   = { 0.75, 0.40, 0.42, 0.7 },
            BORDER_ACCENT  = { 0.70, 0.35, 0.38, 0.6 },
            TITLEBAR_BG    = { 0.22, 0.12, 0.12, 0.98 },
            TITLEBAR_BORDER = { 0.55, 0.30, 0.32, 0.6 },
            BTN_NORMAL     = { 0.24, 0.14, 0.14, 1.0 },
            BTN_HOVER      = { 0.38, 0.18, 0.18, 1.0 },
            BTN_PRESSED    = { 0.32, 0.12, 0.12, 1.0 },
            BTN_BORDER     = { 0.60, 0.32, 0.35, 0.5 },
            BTN_BORDER_HOVER = { 0.78, 0.40, 0.45, 0.7 },
        },
        orange = {
            name = "Burnt Orange",
            BG_PRIMARY     = { 0.15, 0.10, 0.07, 0.97 },
            BG_SECONDARY   = { 0.11, 0.08, 0.05, 0.95 },
            BG_TERTIARY    = { 0.22, 0.14, 0.10, 1.0 },
            BG_HOVER       = { 0.28, 0.18, 0.12, 1.0 },
            BG_ACTIVE      = { 0.32, 0.20, 0.12, 1.0 },
            ACCENT_PRIMARY   = { 0.88, 0.50, 0.25, 1.0 },
            ACCENT_SECONDARY = { 0.70, 0.40, 0.20, 1.0 },
            ACCENT_HIGHLIGHT = { 1.00, 0.62, 0.35, 1.0 },
            ACCENT_MUTED     = { 0.58, 0.38, 0.20, 0.8 },
            TEXT_PRIMARY   = { 0.92, 0.90, 0.87, 1.0 },
            TEXT_SECONDARY = { 0.78, 0.70, 0.62, 1.0 },
            TEXT_MUTED     = { 0.72, 0.66, 0.58, 1.0 },
            TEXT_ACCENT    = { 1.00, 0.70, 0.40, 1.0 },
            BORDER_DEFAULT = { 0.45, 0.30, 0.20, 0.5 },
            BORDER_SUBTLE  = { 0.38, 0.25, 0.18, 0.3 },
            BORDER_FOCUS   = { 0.75, 0.45, 0.25, 0.7 },
            BORDER_ACCENT  = { 0.70, 0.42, 0.25, 0.6 },
            TITLEBAR_BG    = { 0.22, 0.14, 0.10, 0.98 },
            TITLEBAR_BORDER = { 0.55, 0.38, 0.22, 0.6 },
            BTN_NORMAL     = { 0.24, 0.16, 0.11, 1.0 },
            BTN_HOVER      = { 0.32, 0.22, 0.14, 1.0 },
            BTN_PRESSED    = { 0.28, 0.18, 0.11, 1.0 },
            BTN_BORDER     = { 0.60, 0.40, 0.25, 0.5 },
            BTN_BORDER_HOVER = { 0.78, 0.52, 0.32, 0.7 },
        },
        teal = {
            name = "Teal Depths",
            BG_PRIMARY     = { 0.07, 0.12, 0.13, 0.97 },
            BG_SECONDARY   = { 0.05, 0.09, 0.10, 0.95 },
            BG_TERTIARY    = { 0.10, 0.18, 0.20, 1.0 },
            BG_HOVER       = { 0.12, 0.22, 0.25, 1.0 },
            BG_ACTIVE      = { 0.12, 0.24, 0.28, 1.0 },
            ACCENT_PRIMARY   = { 0.30, 0.70, 0.75, 1.0 },
            ACCENT_SECONDARY = { 0.22, 0.55, 0.60, 1.0 },
            ACCENT_HIGHLIGHT = { 0.40, 0.85, 0.92, 1.0 },
            ACCENT_MUTED     = { 0.20, 0.48, 0.52, 0.8 },
            TEXT_PRIMARY   = { 0.87, 0.92, 0.92, 1.0 },
            TEXT_SECONDARY = { 0.60, 0.78, 0.80, 1.0 },
            TEXT_MUTED     = { 0.63, 0.72, 0.74, 1.0 },
            TEXT_ACCENT    = { 0.50, 0.92, 0.98, 1.0 },
            BORDER_DEFAULT = { 0.20, 0.40, 0.45, 0.5 },
            BORDER_SUBTLE  = { 0.15, 0.32, 0.38, 0.3 },
            BORDER_FOCUS   = { 0.35, 0.62, 0.70, 0.7 },
            BORDER_ACCENT  = { 0.30, 0.58, 0.65, 0.6 },
            TITLEBAR_BG    = { 0.10, 0.18, 0.20, 0.98 },
            TITLEBAR_BORDER = { 0.28, 0.50, 0.58, 0.6 },
            BTN_NORMAL     = { 0.12, 0.20, 0.22, 1.0 },
            BTN_HOVER      = { 0.16, 0.28, 0.32, 1.0 },
            BTN_PRESSED    = { 0.12, 0.24, 0.28, 1.0 },
            BTN_BORDER     = { 0.32, 0.55, 0.62, 0.5 },
            BTN_BORDER_HOVER = { 0.42, 0.70, 0.80, 0.7 },
        },
        slate = {
            name = "Slate Grey",
            BG_PRIMARY     = { 0.10, 0.10, 0.12, 0.97 },
            BG_SECONDARY   = { 0.07, 0.07, 0.08, 0.95 },
            BG_TERTIARY    = { 0.14, 0.14, 0.16, 1.0 },
            BG_HOVER       = { 0.18, 0.18, 0.20, 1.0 },
            BG_ACTIVE      = { 0.20, 0.20, 0.24, 1.0 },
            ACCENT_PRIMARY   = { 0.60, 0.60, 0.65, 1.0 },
            ACCENT_SECONDARY = { 0.48, 0.48, 0.52, 1.0 },
            ACCENT_HIGHLIGHT = { 0.75, 0.75, 0.82, 1.0 },
            ACCENT_MUTED     = { 0.40, 0.40, 0.45, 0.8 },
            TEXT_PRIMARY   = { 0.90, 0.90, 0.92, 1.0 },
            TEXT_SECONDARY = { 0.65, 0.65, 0.70, 1.0 },
            TEXT_MUTED     = { 0.66, 0.66, 0.69, 1.0 },
            TEXT_ACCENT    = { 0.75, 0.75, 0.85, 1.0 },
            BORDER_DEFAULT = { 0.30, 0.30, 0.35, 0.5 },
            BORDER_SUBTLE  = { 0.22, 0.22, 0.26, 0.3 },
            BORDER_FOCUS   = { 0.50, 0.50, 0.60, 0.7 },
            BORDER_ACCENT  = { 0.45, 0.45, 0.55, 0.6 },
            TITLEBAR_BG    = { 0.14, 0.14, 0.16, 0.98 },
            TITLEBAR_BORDER = { 0.38, 0.38, 0.45, 0.6 },
            BTN_NORMAL     = { 0.16, 0.16, 0.18, 1.0 },
            BTN_HOVER      = { 0.24, 0.24, 0.28, 1.0 },
            BTN_PRESSED    = { 0.18, 0.18, 0.22, 1.0 },
            BTN_BORDER     = { 0.42, 0.42, 0.50, 0.5 },
            BTN_BORDER_HOVER = { 0.55, 0.55, 0.65, 0.7 },
        },
        gold = {
            name = "Golden",
            BG_PRIMARY     = { 0.14, 0.12, 0.08, 0.97 },
            BG_SECONDARY   = { 0.10, 0.09, 0.06, 0.95 },
            BG_TERTIARY    = { 0.20, 0.17, 0.10, 1.0 },
            BG_HOVER       = { 0.25, 0.21, 0.12, 1.0 },
            BG_ACTIVE      = { 0.28, 0.23, 0.12, 1.0 },
            ACCENT_PRIMARY   = { 0.92, 0.75, 0.28, 1.0 },
            ACCENT_SECONDARY = { 0.75, 0.60, 0.22, 1.0 },
            ACCENT_HIGHLIGHT = { 1.00, 0.88, 0.40, 1.0 },
            ACCENT_MUTED     = { 0.62, 0.50, 0.18, 0.8 },
            TEXT_PRIMARY   = { 0.92, 0.90, 0.85, 1.0 },
            TEXT_SECONDARY = { 0.78, 0.72, 0.60, 1.0 },
            TEXT_MUTED     = { 0.72, 0.66, 0.56, 1.0 },
            TEXT_ACCENT    = { 1.00, 0.90, 0.40, 1.0 },
            BORDER_DEFAULT = { 0.45, 0.38, 0.20, 0.5 },
            BORDER_SUBTLE  = { 0.38, 0.32, 0.18, 0.3 },
            BORDER_FOCUS   = { 0.75, 0.62, 0.30, 0.7 },
            BORDER_ACCENT  = { 0.70, 0.58, 0.28, 0.6 },
            TITLEBAR_BG    = { 0.20, 0.17, 0.10, 0.98 },
            TITLEBAR_BORDER = { 0.55, 0.45, 0.25, 0.6 },
            BTN_NORMAL     = { 0.22, 0.18, 0.10, 1.0 },
            BTN_HOVER      = { 0.30, 0.25, 0.14, 1.0 },
            BTN_PRESSED    = { 0.26, 0.21, 0.10, 1.0 },
            BTN_BORDER     = { 0.60, 0.50, 0.28, 0.5 },
            BTN_BORDER_HOVER = { 0.78, 0.65, 0.35, 0.7 },
        },
        pink = {
            name = "Rose Pink",
...
Addon.Constants.THEME = CopyTable(Addon.Constants.THEMES.green)
