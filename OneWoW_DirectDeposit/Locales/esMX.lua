...
OneWoW.Locale:Register(ADDON_NAME, "esMX", {
    ...
    ["WARBOUND_SECTION"] = "Depósito Automático de Grupo de Guerra",
    ["WARBOUND_ENABLE"] = "Depositar Automáticamente Todos los Objetos del Grupo de Guerra",
    ["WARBOUND_ENABLE_DESC"] = "Al abrir cualquier banco, deposita automáticamente todos los objetos vinculados al grupo de guerra (vinculados a la cuenta) de tus bolsas en el Banco de Grupo de Guerra. Los objetos que ya estén en tu lista de depósito de arriba quedan excluidos.",
    ...
    ["WARBOUND_EXCLUDE_ITEMS_DESC"] = "Estos objetos siempre se conservan en tus bolsas, incluso si están vinculados al grupo de guerra. Arrastra un objeto aquí o introduce su ID de objeto.",
    ...
    ["TOOLTIP_WARBAND"] = "Grupo de Guerra",
    ...
    ["BINDING_NAME_ONEWOW_DIRECTDEPOSIT_ADD_WARBAND"] = "Añadido Rápido: Banco de Grupo de Guerra",
