...
OneWoW.Locale:Register(ADDON_NAME, "itIT", {
    ...
    ["ADDON_SUBTITLE"] = "Gestione Automatica dell'Oro della Banca della Squadra di guerra",
    ...
    ["DIRECT_DEPOSIT_DESCRIPTION"] = "Gestisci automaticamente l'oro tra il tuo personaggio e la Banca della Squadra di guerra. Imposta un importo obiettivo da tenere sul personaggio e il sistema depositerà l'oro in eccesso o lo preleverà quando ne manca. Perfetto per gestire l'oro tra più personaggi.",
    ["DIRECT_DEPOSIT_ENABLE"] = "Attiva Deposito Diretto",
    ["DIRECT_DEPOSIT_ENABLE_DESC"] = "Deposita o preleva automaticamente l'oro dalla tua Banca della Squadra di guerra per mantenere un importo obiettivo sul personaggio quando apri la banca.",
    ...
    ["DEPOSIT_ENABLE"] = "Deposita Oro nella Banca della Squadra di guerra",
    ["DEPOSIT_ENABLE_DESC"] = "Quando hai più dell'importo obiettivo, deposita automaticamente l'eccesso nella tua Banca della Squadra di guerra.",

    ["WITHDRAW_ENABLE"] = "Preleva Oro dalla Banca della Squadra di guerra",
    ["WITHDRAW_ENABLE_DESC"] = "Quando hai meno dell'importo obiettivo, preleva automaticamente dalla tua Banca della Squadra di guerra per raggiungere l'obiettivo.",
    ...
    ["ITEM_DEPOSIT_WARBAND"] = "Squadra di guerra",
    ...
    ["KEYBIND_ADD_WARBAND"] = "Aggiungi Oggetto sotto il Cursore - Banca della Squadra di guerra",
    ...
    ["WARBOUND_SECTION"] = "Deposito Automatico Squadra di guerra",
    ["WARBOUND_ENABLE"] = "Deposita Automaticamente Tutti gli Oggetti della Squadra di guerra",
    ["WARBOUND_ENABLE_DESC"] = "All'apertura di qualsiasi banca, deposita automaticamente tutti gli oggetti legati alla squadra di guerra (legati all'account) dalle tue borse nella Banca della Squadra di guerra. Gli oggetti già presenti nella lista di deposito qui sopra vengono esclusi.",
    ...
    ["WARBOUND_EXCLUDE_ITEMS_DESC"] = "Questi oggetti vengono sempre mantenuti nelle tue borse, anche se legati alla squadra di guerra. Trascina qui un oggetto o inserisci il suo ID oggetto.",
    ...
    ["TOOLTIP_WARBAND"] = "Squadra di guerra",
    ...
    ["BINDING_NAME_ONEWOW_DIRECTDEPOSIT_ADD_WARBAND"] = "Aggiunta Rapida: Banca della Squadra di guerra",
