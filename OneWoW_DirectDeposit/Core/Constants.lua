...
OneWoW_DirectDeposit.Constants = {
    VERSION = "R5.2602.1400",
    ADDON_NAME = "OneWoW_DirectDeposit",
...
OneWoW_DirectDeposit.THEME = OneWoW_DirectDeposit.Constants.THEME
OneWoW_DirectDeposit.SPACING = OneWoW_DirectDeposit.Constants.SPACING
