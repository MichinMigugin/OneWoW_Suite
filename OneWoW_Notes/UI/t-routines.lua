...
function ns.UI.CreateRoutinesTab(parent)
    ...
    local function ShowRoutineDetail(routineID)
        ...
        local titleEditBox = OneWoW_GUI:CreateEditBox(headerFrame, { height = 25, width = 300 })
...
function ns.UI.ShowRoutineSectionEditorDialog(routineID, callback)
    ...
    local nameBox = OneWoW_GUI:CreateEditBox(content, { height = 25, width = 200 })
...
function ns.UI.ShowRoutineTaskEditorDialog(routineID, sectionIndex, callback)
    ...
    local nameBox = OneWoW_GUI:CreateEditBox(content, { height = 25, width = 260 })
    nameBox:SetPoint("TOPLEFT", nameLabel, "BOTTOMLEFT", 0, -4)
    nameBox:SetAutoFocus(false)
    nameBox:SetTextColor(OneWoW_GUI:GetThemeColor("TEXT_PRIMARY"))
    ...
    local maxBox = OneWoW_GUI:CreateEditBox(content, { height = 25, width = 80 })
    ...
    local justTrackCheckbox = OneWoW_GUI:CreateCheckbox(content, { label = L["ROUTINES_JUST_TRACK"] })
    ...
    local questBox = OneWoW_GUI:CreateEditBox(content, { height = 25, width = 260 })
