...
-- OneWay Pins
    ...
    ["WAYPINS_HIDE_NOTE"] = "Ocultar notas de zona",
    ...
    ["WAYPINS_MAP_PANEL_EMPTY"] = "No hay OneWay Pins en este mapa.",
    ...
    ["WAYPINS_SETTINGS_HINT"] = "Mapa, clic, tamano y animacion. Activa o desactiva la funcion aqui, o en Gestionar funciones bajo Notes.",
