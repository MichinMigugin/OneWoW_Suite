...
-- OneWay Pins
    ...
    ["WAYPINS_SELECT"] = "Selecciona un OneWay Pin para verlo.",
    ...
    ["WAYPINS_ADD_TO_ZONE"] = "Añadir a notas de zona",
    ...
    ["WAYPINS_FIND_HINT"] = "Busca una zona y filtra: Vendors, banker, repair, professions, Eng. Un ! excluye (!repair).",
    ...
    ["WAYPINS_LAYERS_WARN"] = "Cada capa extra (icono, fondo, efectos) usa mas memoria. Anade solo lo que necesites.",
    ["WAYPINS_OPEN_TAB"] = "Abrir OneWay Pins",
    ["WAYPINS_MAP_BTN_TT"] = "OneWay Pins. Clic para mostrar/ocultar y filtrar.",
    ["SETTINGS_WAYPINS_WORLD_DESC"] = "Dibuja OneWay Pins en el mapa del mundo.",
    ["SETTINGS_WAYPINS_MINIMAP_DESC"] = "Dibuja OneWay Pins en el minimapa. El tamano predeterminado esta abajo; cada marca puede cambiar el tamano en el mapa del mundo.",
