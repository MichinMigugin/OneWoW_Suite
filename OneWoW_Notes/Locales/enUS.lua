...
-- OneWay Pins
    ...
    ["WAYPINS_SELECT"] = "Select a OneWay Pin to view.",
    ...
    ["WAYPINS_ADD_TO_ZONE"] = "Add to Zone Notes",
    ...
    ["WAYPINS_FIND_HINT"] = "Search a zone, then filter: Vendors, banker, repair, professions, Eng. Prefix ! to hide a match (!repair).",
    ...
    ["WAYPINS_LAYERS_WARN"] = "Each extra layer (icon, background, effects) uses more memory. Add only what you need.",
    ["WAYPINS_OPEN_TAB"] = "Open OneWay Pins",
    ["WAYPINS_MAP_BTN_TT"] = "OneWay Pins. Click for show/hide and filters.",
    ["SETTINGS_WAYPINS_WORLD_DESC"] = "Draw OneWay Pins on the world map.",
    ["SETTINGS_WAYPINS_MINIMAP_DESC"] = "Draw OneWay Pins on the minimap. Default size is below; each pin can override world map size.",
