...
-- OneWay Pins
    ...
    ["WAYPINS_HIDE_NOTE"] = "Hide Zone Notes",
    ...
    ["WAYPINS_MAP_PANEL_EMPTY"] = "No OneWay Pins on this map.",
    ...
    ["WAYPINS_SETTINGS_HINT"] = "Map, click, size, and animation options. Turn the feature on or off here, or in Manage Features under Notes.",
