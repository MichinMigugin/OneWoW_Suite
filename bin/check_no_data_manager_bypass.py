...
independently. See OneWoW/Docs/Load-Unit-Map.md §10.3, §10.7, §10.8.
...
Enforcement ramp (Load-Unit-Map.md §10.8)
...
# --- Enforcement phase (see module docstring / Load-Unit-Map.md §10.8) ---------
...
def main(argv: list[str]) -> int:
    ...
    if seen_keys and (WARN_ONLY or blocking):
        ...
        print("Reference: OneWoW/Docs/Load-Unit-Map.md §10.3, §10.7, §10.8")
        if WARN_ONLY:
            print()
