...
Reads OneWoW/GUI/Constants.lua, parses THEMES_ORDER and per-theme RGB tokens.
Uses opaque sRGB relative luminance (ignores alpha — same limitation as most web checkers).

Run from repo root:
  python bin/theme_contrast_check.py
...
def main() -> int:
    ...
    constants = here.parent.parent / "OneWoW" / "GUI" / "Constants.lua"
