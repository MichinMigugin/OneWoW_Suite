**OneWoW Catalog** is an in-game reference for instances, vendors, professions/recipes, quests, item sources, collectibles, and housing decor.

**Requires:** [OneWoW](Home) core. Enable **Catalog** under [Manage Features](Getting-Started). Companion **CatDB** packs fill Journal, Vendors, Tradeskills, Quests, and Item Search: Zones, NPCs, Items, Quests (Current and Archive), and Tradeskills. Collectibles and Housing list from the game journals.
...
| **NPCs** | `OneWoW_CatDB_NPCDB` | Vendors tab: Classic through Midnight shops, trainers, titled services (inns, repair, stables, flight masters, bankers), and quest givers plus stock (live scan fills gaps) |
