...
* **Journal** — dungeons, raids, Delves, and World hubs across expansions; encounters, Adventure Guide loot, Also from ATT extras, and achievements when Journal data is installed. The pin next to the favorite star opens the map and marks the entrance.
...
* Instance Type includes World (outdoor hubs, plus a World card for Classic through Cataclysm) and Delves (The War Within and Midnight). Loot matches the Adventure Guide; extra AllTheThings drops sit under Also from ATT. While Delves is selected, **Show Bountiful** sits next to Has uncollected and keeps only this week's bountiful doors. The checkbox clears when you close Catalog or press Clear.
