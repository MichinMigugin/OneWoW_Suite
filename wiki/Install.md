...
| **Catalog data** | `OneWoW_CatDB_*` | CatDB packs (Zones, NPCs, Items, Quests, Tradeskills) — enable with Catalog. Older `OneWoW_CatalogData_*` folders may still be in the zip as leftover packs |
