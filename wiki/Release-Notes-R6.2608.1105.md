...
#### Slash commands
- Deprecated suite slash aliases are removed — use the `/1w…` commands on Home (addon cards and Command Options). QoL module shortcuts like `/bagbar` and `/copytext` are unchanged
