...
metadata:
  canonical: .cursor/skills/wow-frame-script-pitfalls/SKILL.md
  stub-for: codex
---
...
`.cursor/skills/wow-frame-script-pitfalls/SKILL.md`

Apply all instructions from that file. This stub exists only for agent skill discovery.
