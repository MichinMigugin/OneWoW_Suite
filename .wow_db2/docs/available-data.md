...
- **World entrance pin** — `JournalInstanceEntrance` — Have (Catalog journal card pin). Cards without a row use hand-curated Wowhead `/way` fallbacks until this table ships them.
