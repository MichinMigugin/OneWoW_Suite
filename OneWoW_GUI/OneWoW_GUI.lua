...
function OneWoW_GUI:SkinIconFrame(frame, options)
    ...
    if borderSize > 0 then
        ...
        if quality and quality > 1 then
            ...
            frame._skinBorder:SetBackdropBorderColor(GetThemeColor(borderColorKey))
        end
...
function OneWoW_GUI:UpdateIconQuality(frame, quality)
    ...
    if quality and quality > 1 then
        ...
        frame._skinBorder:SetBackdropBorderColor(GetThemeColor(key))
    end
end
...
function OneWoW_GUI:CreateSkinnedIcon(parent, options)
    ...
    if borderSize > 0 then
        ...
        if quality and quality > 1 then
            ...
            borderFrame:SetBackdropBorderColor(GetThemeColor(options.borderColorKey or "BORDER_DEFAULT"))
        end
    ...
    if itemLink then
        iconFrame:SetScript("OnEnter", function(self)
            if hasHoverBorder then
                self._skinBorder:SetBackdropBorderColor(GetThemeColor(self._skinHoverBorderColorKey or "BORDER_ACCENT"))
            end
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
            GameTooltip:SetHyperlink(itemLink)
            GameTooltip:Show()
        ...
        iconFrame:SetScript("OnLeave", function(self)
            if hasHoverBorder then
                self._skinBorder:SetBackdropBorderColor(GetThemeColor(self._skinBorderColorKey or "BORDER_DEFAULT"))
            end
            GameTooltip:Hide()
