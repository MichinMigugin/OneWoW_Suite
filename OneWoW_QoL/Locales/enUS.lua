...
OneWoW.Locale:Register(ADDON_NAME, "enUS", {
    ...
    ["PORTAL_SHOW_SEASON1_DESC"] = "Include Midnight Season 1 dungeon portals on the ESC strip when you know them.",
    ["PORTAL_SHOW_SEASON2"] = "Show Season 2",
    ["PORTAL_SHOW_SEASON2_DESC"] = "Include Midnight Season 2 dungeon portals on the ESC strip when you know them.",
