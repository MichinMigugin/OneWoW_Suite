...
OneWoW.Locale:Register(ADDON_NAME, "ptBR", {
    ...
    ["TIPS_COLLECTIONS_DESC"] = "Mostra o status de coleção no cabeçalho do tipo de item. Quando ativado, os itens colecionáveis mostram Coletado ou Não coletado ao lado do tipo. Cobre montarias, mascotes, brinquedos, receitas e transmogrificação. Receitas podem mostrar status de alts conforme a configuração abaixo.",
