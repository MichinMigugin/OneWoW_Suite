...
OneWoW.Locale:Register(ADDON_NAME, "deDE", {
    ...
    ["TIPS_COLLECTIONS_DESC"] = "Zeigt den Sammelstatus in der Gegenstandstyp-Überschrift an. Wenn aktiviert, zeigen Sammelgegenstände Gesammelt oder Nicht gesammelt neben ihrem Typ an. Deckt Reittiere, Begleiter, Spielzeuge, Rezepte und Transmogrifikation ab. Rezepte können bei Bedarf den Twink-Status anzeigen.",
