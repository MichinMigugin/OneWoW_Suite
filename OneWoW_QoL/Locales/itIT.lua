...
OneWoW.Locale:Register(ADDON_NAME, "itIT", {
    ...
    ["TIPS_COLLECTIONS_DESC"] = "Mostra lo stato di collezione nell'intestazione del tipo di oggetto. Quando attivo, gli oggetti collezionabili mostrano Collezionato o Non collezionato accanto al loro tipo. Copre cavalcature, mascotte, giocattoli, ricette e trasmogrificazione. Le ricette possono mostrare lo stato degli alt secondo l'impostazione sotto.",
