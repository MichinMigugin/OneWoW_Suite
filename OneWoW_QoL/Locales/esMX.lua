...
OneWoW.Locale:Register(ADDON_NAME, "esMX", {
    ...
    ["TIPS_ENHANCEMENTS_SECTION_PLAYERINFO_DESC"] = "Información adicional que se muestra al pasar el mouse sobre otros jugadores.",
    ...
    ["TIPS_ENHANCEMENTS_PLAYER_TARGET_DESC"] = "Muestra a quién tiene como objetivo el jugador sobre el que pasas el mouse.",
    ["TIPS_ENHANCEMENTS_MYTHIC_SCORE"] = "Puntuación Mítica+",
    ["TIPS_ENHANCEMENTS_MYTHIC_SCORE_DESC"] = "Muestra la puntuación Mítica+ del jugador sobre el que pasas el mouse.",
    ...
    ["TIPS_TALENTMODS_DESC"] = "Al pasar el mouse sobre un hechizo o macro, muestra cuáles de tus talentos activos modifican o mejoran esa habilidad.",
    ...
    ["SETTINGS_PORTALHUB_HOVER_TO_EXPAND"] = "Pasa el mouse para expandir",
    ["SETTINGS_PORTALHUB_HOVER"] = "Pasar el mouse",
...
ejemplo completo y funcional.]],
    ...
    ["TOGGLE_NAME_ActionButtonUseKeyDown"] = "Botones de acción al presionar",
    ...
    ["TOGGLE_NAME_lootUnderMouse"] = "Ventana de botín bajo el mouse",
    ...
    ["TOGGLE_DESC_ActionButtonUseKeyDown"] = "Activado: los hechizos se lanzan al instante al presionar la tecla. Desactivado: los hechizos se lanzan al soltarla, permitiéndote ver primero el alcance.",
    ...
    ["TOGGLE_DESC_lootUnderMouse"] = "Abre la ventana de botín donde esté el cursor del mouse en lugar de en una posición fija.",
    ...
    ["TOGGLE_DESC_cameraZoomSpeed"] = "Velocidad a la que la cámara se acerca y se aleja con la rueda del mouse.",
    ...
    ["TOGGLE_DESC_chatMouseScroll"] = "Desplázate por el historial del chat con la rueda del mouse.",
    ...
    ["TOGGLE_DESC_gxFixLag"] = "Reduce el retardo de entrada del cursor del mouse en algunos sistemas modificando la cola de renderizado.",
