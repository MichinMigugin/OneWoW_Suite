...
OneWoW.Locale:Register(M._scope, "deDE", {
    ...
    ["BAGBAR_CLEAR_BLACKLIST"] = "Sperrliste leeren",
    ["BAGBAR_BLACKLIST_CLEARED"] = "Sperrliste der Taschenleiste geleert.",
    ["BAGBAR_CLEAR_BLACKLIST_CONFIRM"] = "Möchtest du wirklich die gesamte Sperrliste der Taschenleiste leeren?",
