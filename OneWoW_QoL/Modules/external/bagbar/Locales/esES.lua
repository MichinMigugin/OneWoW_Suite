...
OneWoW.Locale:Register(M._scope, "esES", {
    ...
    ["BAGBAR_CLEAR_BLACKLIST"] = "Limpiar lista negra",
    ["BAGBAR_BLACKLIST_CLEARED"] = "Lista negra de la barra de bolsa limpiada.",
    ["BAGBAR_CLEAR_BLACKLIST_CONFIRM"] = "¿Seguro que quieres limpiar toda la lista negra de la barra de bolsa?",
