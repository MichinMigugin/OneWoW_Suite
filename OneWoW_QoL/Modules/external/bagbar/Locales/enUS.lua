...
L["BAGBAR_RIGHT_CLICK_TO_SKIP"]           = "Right-click to skip this session"
L["BAGBAR_CTRL_RIGHT_CLICK_TO_BLACKLIST"] = "Ctrl+Right-click to permanently blacklist"
...
L["BAGBAR_BLACKLIST_DESC"]                = "Right-click items in the bar to skip for this session. Ctrl+Right-click to permanently blacklist."
