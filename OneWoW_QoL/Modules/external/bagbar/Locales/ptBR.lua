...
OneWoW.Locale:Register(M._scope, "ptBR", {
    ...
    ["BAGBAR_CLEAR_BLACKLIST"] = "Limpar lista negra",
    ["BAGBAR_BLACKLIST_CLEARED"] = "Lista negra da barra de bolsa limpa.",
    ["BAGBAR_CLEAR_BLACKLIST_CONFIRM"] = "Tem certeza de que deseja limpar toda a lista negra da barra de bolsa?",
