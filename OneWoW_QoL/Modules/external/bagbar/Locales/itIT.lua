...
OneWoW.Locale:Register(M._scope, "itIT", {
    ...
    ["BAGBAR_CLEAR_BLACKLIST"] = "Svuota lista nera",
    ["BAGBAR_BLACKLIST_CLEARED"] = "Lista nera della barra delle borse svuotata.",
    ["BAGBAR_CLEAR_BLACKLIST_CONFIRM"] = "Sei sicuro di voler svuotare l'intera lista nera della barra delle borse?",
