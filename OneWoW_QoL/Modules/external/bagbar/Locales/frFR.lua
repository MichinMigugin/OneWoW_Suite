...
OneWoW.Locale:Register(M._scope, "frFR", {
    ...
    ["BAGBAR_CLEAR_BLACKLIST"] = "Vider la liste noire",
    ["BAGBAR_BLACKLIST_CLEARED"] = "Liste noire de la barre de sac vidée.",
    ["BAGBAR_CLEAR_BLACKLIST_CONFIRM"] = "Voulez-vous vraiment vider toute la liste noire de la barre de sac ?",
