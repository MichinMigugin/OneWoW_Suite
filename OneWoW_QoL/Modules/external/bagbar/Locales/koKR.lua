...
OneWoW.Locale:Register(M._scope, "koKR", {
    ...
    ["BAGBAR_SHOW_BAR"] = "바 표시",
    ["BAGBAR_HIDE_BAR"] = "바 숨기기",
    ["BAGBAR_CLEAR_BLACKLIST_CONFIRM"] = "가방 바 차단 목록을 모두 비우시겠습니까?",
    ["BAGBAR_ICON_SPACING"] = "아이콘 간격",
    ["BAGBAR_COLUMNS"] = "열",
    ["BAGBAR_CONTEXT_LOCK"] = "위치 고정",
    ["BAGBAR_CONTEXT_UNLOCK"] = "위치 고정 해제",
    ["BAGBAR_CONTEXT_SETTINGS"] = "설정 열기",
    ["BAGBAR_HIDE_ANCHOR"] = "고정점 숨기기 (마우스를 올리면 표시)",
    ["BAGBAR_GROW_DIRECTION"] = "늘어나는 방향",
