...
L["MMSKIN_TITLE"]                   = "Minimap Skin"
L["MMSKIN_DESC"]                    = "Customize your minimap with shape, border, zone text, clock, click actions, zoom controls, element visibility, and more. Theme-aware and fully configurable."
...
L["MMSKIN_SECTION_SCALE"]           = "Scale"
L["MMSKIN_SCALE_LABEL"]             = "Minimap Scale"
...
L["MMSKIN_USE_THEME_COLOR_DESC"]    = "Use the OneWoW theme accent color for the border instead of a custom color."

L["MMSKIN_SECTION_ZOOM"]            = "Zoom Settings"
L["MMSKIN_AUTO_ZOOM_DELAY"]         = "Auto Zoom Delay"
L["MMSKIN_SHOW_ZOOM_BTNS"]          = "Show Zoom Buttons"
L["MMSKIN_SHOW_ZOOM_BTNS_DESC"]     = "Show the zoom in/out buttons on the minimap."
...
L["MMSKIN_SECTION_ELEMENTS"]        = "Additional Elements"
L["MMSKIN_SHOW_COMPARTMENT"]        = "Addon Compartment"
L["MMSKIN_SHOW_COMPARTMENT_DESC"]   = "Show the addon compartment button on the minimap."

L["MMSKIN_CLOCK_TT_TOGGLE"]         = "Click to toggle the Time Manager"

L["MMSKIN_UNCLAMP"]                 = "Unclamp from Screen"
L["MMSKIN_UNCLAMP_DESC"]            = "Allow the minimap to be positioned at the very edge of the screen."

L["MMSKIN_SECTION_ZONE_FONT"]       = "Zone Text Font"
L["MMSKIN_ZONE_FONT_LABEL"]         = "Font"
L["MMSKIN_ZONE_FONT_SIZE"]          = "Font Size"
L["MMSKIN_SECTION_CLOCK_FONT"]      = "Clock Font"
