...
OneWoW.Locale:Register(M._scope, "ruRU", {
    ...
    ["COPYTEXT_DESC"] = "Копирует видимый текст из подсказок или элементов интерфейса в буфер обмена. Используйте /copytext (или /ct), чтобы скопировать то, что находится под курсором.",
