...
OneWoW.Locale:Register(M._scope, "frFR", {
    ...
    ["FRAMEMOVER_DESC"] = "Glissez les cadres de l'interface Blizzard pour les repositionner. Utilisez Ctrl+Molette pour les redimensionner. Les positions et les échelles peuvent persister d'une session à l'autre.",
    ...
    ["FRAMEMOVER_ENABLED_TOOLTIP"] = "Clic gauche pour activer/désactiver. Ctrl+Molette sur un cadre pour le redimensionner.",
    ["FEATURES_ON"] = "Activé",
