...
OneWoW.Locale:Register(M._scope, "itIT", {
    ...
    ["FRAMEMOVER_DESC"] = "Trascina i riquadri dell'interfaccia Blizzard per riposizionarli. Usa Ctrl+Rotellina per ridimensionare. Posizioni e scale possono persistere tra le sessioni.",
    ...
    ["FRAMEMOVER_ENABLED_TOOLTIP"] = "Clic sinistro per attivare/disattivare. Ctrl+Rotellina su un riquadro per ridimensionarlo.",
    ["FEATURES_ON"] = "Attivo",
