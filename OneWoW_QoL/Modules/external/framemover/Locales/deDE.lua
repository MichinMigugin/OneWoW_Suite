...
OneWoW.Locale:Register(M._scope, "deDE", {
    ...
    ["FRAMEMOVER_DESC"] = "Ziehe Blizzard-Benutzeroberflächenfenster, um sie neu zu positionieren. Verwende Strg+Scrollen zum Skalieren. Positionen und Skalierungen können sitzungsübergreifend erhalten bleiben.",
    ...
    ["FRAMEMOVER_ENABLED_TOOLTIP"] = "Linksklick zum Umschalten. Strg+Scrollen über ein Fenster, um es zu skalieren.",
    ["FEATURES_ON"] = "An",
    ["FEATURES_OFF"] = "Aus",
})
