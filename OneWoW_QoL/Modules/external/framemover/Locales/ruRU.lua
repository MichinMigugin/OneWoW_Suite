...
OneWoW.Locale:Register(M._scope, "ruRU", {
    ...
    ["FRAMEMOVER_DESC"] = "Перетаскивайте окна интерфейса Blizzard, чтобы изменить их положение. Используйте Ctrl+прокрутку для масштабирования. Положения и масштабы могут сохраняться между сеансами.",
    ...
    ["FRAMEMOVER_ENABLED_TOOLTIP"] = "Левый щелчок для переключения. Ctrl+прокрутка над окном, чтобы изменить его масштаб.",
    ["FEATURES_ON"] = "Вкл",
    ["FEATURES_OFF"] = "Выкл",
})
