...
OneWoW.Locale:Register(M._scope, "frFR", {
    ...
    ["AUTOOPEN_BLACKLIST_ADD"] = "Ajouter l'ID d'objet :",
    ["AUTOOPEN_BLACKLIST_EMPTY"] = "Aucun objet sur liste noire",
    ["AUTOOPEN_BLACKLIST_REMOVED"] = "Retiré de la liste noire : %s",
    ["AUTOOPEN_BLACKLIST_ADDED"] = "Ajouté à la liste noire : %s",
    ["AUTOOPEN_BLACKLIST_CLEARED"] = "Liste noire vidée.",
})
