...
OneWoW.Locale:Register(M._scope, "ptBR", {
    ...
    ["AUTOOPEN_BLACKLIST_ADD"] = "Adicionar ID do item:",
    ["AUTOOPEN_BLACKLIST_EMPTY"] = "Nenhum item na lista negra",
    ["AUTOOPEN_BLACKLIST_REMOVED"] = "Removido da lista negra: %s",
    ["AUTOOPEN_BLACKLIST_ADDED"] = "Adicionado à lista negra: %s",
    ["AUTOOPEN_BLACKLIST_CLEARED"] = "Lista negra limpa.",
})
