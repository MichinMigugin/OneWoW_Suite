...
local function GetBrandIcon()
    ...
    if factionTheme == "alliance" then
        return "Interface\\AddOns\\OneWoW_QoL\\Media\\alliance-mini.png"
    elseif factionTheme == "neutral" then
        return "Interface\\AddOns\\OneWoW_QoL\\Media\\neutral-mini.png"
    else
        return "Interface\\AddOns\\OneWoW_QoL\\Media\\horde-mini.png"
    end
end

local function CreateTitleBar(parent, titleLocaleKey, onClose)
    ...
    titleText:SetText(titleLocaleKey)
...
local function StyleScrollBar(scrollFrame)
    ...
    if scrollBar.Track then
        ...
        if scrollBar.Track.Middle then scrollBar.Track.Middle:SetColorTexture(T("BG_TERTIARY")) end
    end
    ...
    scrollBar:SetScript("OnEnter", function(self)
        if self.ThumbTexture then self.ThumbTexture:SetColorTexture(T("ACCENT_HIGHLIGHT")) end
    end)
    scrollBar:SetScript("OnLeave", function(self)
        if self.ThumbTexture then self.ThumbTexture:SetColorTexture(T("ACCENT_PRIMARY")) end
    end)
end
...
function VendorPanel:CreateVendorButton()
    ...
    state.vendorButton:SetBackdrop(BACKDROP_INNER)
    state.vendorButton:SetBackdropColor(T("BTN_NORMAL"))
    state.vendorButton:SetBackdropBorderColor(T("BTN_BORDER"))

    local fs = state.vendorButton:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    fs:SetPoint("CENTER")
    fs:SetText("Sell (0/0)")
    fs:SetTextColor(T("TEXT_ACCENT"))
    ...
    state.vendorButton:SetScript("OnEnter", function(self)
        ...
        fs:SetTextColor(T("ACCENT_HIGHLIGHT"))
    end)
    ...
    state.vendorButton:SetScript("OnEnter", function(self)
        ...
        GameTooltip:SetText(ns.L["VENDOR_JUNK_MANAGER"], T("TEXT_ACCENT"))
        GameTooltip:AddLine(ns.L["VENDOR_SELL_JUNK"], 1, 1, 1, true)
        GameTooltip:AddLine(ns.L["VENDOR_TOGGLE_PANEL"], 1, 1, 1, true)
        GameTooltip:AddLine(" ", 1, 1, 1)
        GameTooltip:AddLine(string.format(ns.L["VENDOR_COUNTS_LABEL"], junkCount, destroyCount), T("TEXT_SECONDARY"))
        GameTooltip:Show()
    end)
    state.vendorButton:SetScript("OnLeave", function(self)
        self:SetBackdropColor(T("BTN_NORMAL"))
...
function VendorPanel:CreatePanelToggleButton()
    ...
    state.panelToggleButton:SetScript("OnEnter", function(self)
        ...
        GameTooltip:SetText(ns.L["VENDOR_TOGGLE_PANEL_TOOLTIP"], T("TEXT_ACCENT"))
...
function VendorPanel:CreateReplacementSellButton()
    ...
    state.replacementSellButton:SetBackdrop(BACKDROP_INNER)
    state.replacementSellButton:SetBackdropColor(T("BTN_NORMAL"))
    state.replacementSellButton:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    state.replacementSellButton:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine(ns.L["VENDOR_JUNK_MANAGER"], T("TEXT_ACCENT"))
        GameTooltip:AddLine(ns.L["VENDOR_SELL_JUNK"], 1, 1, 1, true)
        GameTooltip:AddLine(" ", 1, 1, 1)
        GameTooltip:AddLine(string.format(ns.L["VENDOR_COUNTS_LABEL"], junkCount, destroyCount), T("TEXT_SECONDARY"))
        GameTooltip:Show()
...
function VendorPanel:CreatePreviewPanel()
    ...
    state.junkPreviewPanel:SetBackdrop(BACKDROP_INNER)
    state.junkPreviewPanel:SetBackdropColor(T("BG_PRIMARY"))
    state.junkPreviewPanel:SetBackdropBorderColor(T("BORDER_DEFAULT"))

    local titleBar = CreateTitleBar(
        state.junkPreviewPanel,
        ns.L["VENDOR_TOOLS_TITLE"],
        function()
    ...
    filterRow:SetBackdropColor(T("BG_SECONDARY"))

    local filterLabel = filterRow:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    filterLabel:SetPoint("LEFT", filterRow, "LEFT", S("SM"), 0)
    filterLabel:SetText(ns.L["VENDOR_FILTER_LABEL"])
    filterLabel:SetTextColor(T("TEXT_SECONDARY"))

    local vendorDropdown = CreateFrame("Button", "OneWoW_QoL_VendorItemFilter", filterRow, "BackdropTemplate")
    vendorDropdown:SetPoint("LEFT", filterLabel, "RIGHT", S("XS"), 0)
    vendorDropdown:SetPoint("RIGHT", filterRow, "RIGHT", -S("SM"), 0)
    vendorDropdown:SetHeight(22)
    vendorDropdown:SetBackdrop(BACKDROP_INNER)
    vendorDropdown:SetBackdropColor(T("BG_TERTIARY"))
    vendorDropdown:SetBackdropBorderColor(T("BORDER_SUBTLE"))

    local dropText = vendorDropdown:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    dropText:SetPoint("LEFT", vendorDropdown, "LEFT", S("SM"), 0)
    ...
    dropArrow:SetPoint("RIGHT", vendorDropdown, "RIGHT", -S("XS"), 0)
    ...
    local function CreateDropdownMenu()
        ...
        dropdownMenu:SetBackdrop(BACKDROP_INNER)
        dropdownMenu:SetBackdropColor(T("BG_PRIMARY"))
        dropdownMenu:SetBackdropBorderColor(T("BORDER_DEFAULT"))
        ...
        local function AddItem(text, onClick, isChecked)
            ...
            btnText:SetPoint("LEFT", btn, "LEFT", S("SM"), 0)
            ...
            if isChecked then
                ...
                check:SetSize(10, 10)
                check:SetPoint("RIGHT", btn, "RIGHT", -S("XS"), 0)
                check:SetColorTexture(T("ACCENT_PRIMARY"))
            end
        ...
        local function AddHeader(text)
            ...
            header:SetPoint("TOPLEFT", scrollChild, "TOPLEFT", S("SM"), -yOff - 4)
            header:SetText(text)
        ...
        local function AddSpacer()
            ...
            divider:SetPoint("TOPLEFT", scrollChild, "TOPLEFT", S("SM"), -yOff - 4)
            divider:SetPoint("TOPRIGHT", scrollChild, "TOPRIGHT", -S("SM"), -yOff - 4)
            divider:SetHeight(1)
        ...
        if hasEquipable then
            ...
            checkBox:SetPoint("LEFT", checkRow, "LEFT", S("XS"), 0)
            ...
            checkLabel:SetTextColor(T("TEXT_PRIMARY"))

            checkRow:SetScript("OnEnter", function(self)
                self:SetBackdropColor(T("BG_HOVER"))
                checkLabel:SetTextColor(T("TEXT_ACCENT"))
            end)
    ...
    dimLabel:SetTextColor(T("TEXT_SECONDARY"))
    ...
    dimKnownRow:SetScript("OnEnter", function(self)
        self:SetBackdropColor(T("BG_HOVER"))
        dimLabel:SetTextColor(T("TEXT_PRIMARY"))
    end)
    ...
    local quickAddBtn = ns.UI.CreateButton(nil, state.junkPreviewPanel, ns.L["VENDOR_QUICK_ADD"], panelWidth - 16, 26)
    quickAddBtn:SetPoint("TOPLEFT", dimKnownRow, "BOTTOMLEFT", S("SM"), -S("XS"))
    quickAddBtn:SetPoint("TOPRIGHT", dimKnownRow, "BOTTOMRIGHT", -S("SM"), -S("XS"))
    ...
    quickAddBtn:SetScript("OnEnter", function(self)
        ...
        GameTooltip:SetText(ns.L["VENDOR_QUICK_ADD_FILTERS"], T("TEXT_ACCENT"))
    ...
    scrollFrame:SetPoint("TOPLEFT", quickAddBtn, "BOTTOMLEFT", 0, -S("XS"))
    scrollFrame:SetPoint("BOTTOMRIGHT", state.junkPreviewPanel, "BOTTOMRIGHT", -S("SM"), 80)
    ...
    local bottomCloseBtn = ns.UI.CreateButton(nil, state.junkPreviewPanel, ns.L["VENDOR_CLOSE"], 85, 28)
    bottomCloseBtn:SetPoint("BOTTOMLEFT", state.junkPreviewPanel, "BOTTOMLEFT", S("SM"), 12)
    ...
    bottomCloseBtn:SetScript("OnEnter", function(self)
        ...
        GameTooltip:SetOwner(self, "ANCHOR_TOP")
        GameTooltip:SetText(ns.L["VENDOR_CLOSE_PANEL"], T("TEXT_ACCENT"))
        GameTooltip:AddLine(ns.L["VENDOR_HIDES_PANEL"], 1, 1, 1, true)
        GameTooltip:AddLine(ns.L["VENDOR_USE_TOGGLE"], T("TEXT_SECONDARY"))
        GameTooltip:Show()
    end)
    ...
    helpText:SetTextColor(T("TEXT_MUTED"))
    ...
    totalValueText:SetTextColor(T("TEXT_ACCENT"))
    state.junkPreviewPanel.totalValueText = totalValueText

    local destroyButton = ns.UI.CreateButton(nil, state.junkPreviewPanel, string.format(ns.L["VENDOR_DESTROY_COUNT"], 0), 110, 28)
    ...
    local sellJunkButton = ns.UI.CreateButton(nil, state.junkPreviewPanel, string.format(ns.L["VENDOR_SELL_COUNT"], 0), 110, 28)
    ...
    sellJunkButton:SetScript("OnEnter", function(self)
        ...
        self.text:SetTextColor(T("TEXT_ACCENT"))
        GameTooltip:SetOwner(self, "ANCHOR_TOP")
        GameTooltip:SetText(ns.L["VENDOR_SELL_JUNK_ITEMS"], T("TEXT_ACCENT"))
...
function VendorPanel:CreateFiltersDialog()
    ...
    state.filtersDialog:SetBackdrop(BACKDROP_INNER)
    state.filtersDialog:SetBackdropColor(T("BG_PRIMARY"))
    state.filtersDialog:SetBackdropBorderColor(T("BORDER_DEFAULT"))
    ...
    local reagentsBtn = ns.UI.CreateButton(nil, state.filtersDialog, ns.L["VENDOR_REAGENTS"], 176, 26)
    ...
    reagentsBtn:SetScript("OnEnter", function(self)
        ...
        self.text:SetTextColor(T("TEXT_ACCENT"))
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText(ns.L["UI_VENDOR_REAGENTS_TITLE"], T("TEXT_ACCENT"))
        GameTooltip:AddLine(ns.L["UI_VENDOR_REAGENTS"], 1, 1, 1, true)
        GameTooltip:AddLine(ns.L["UI_VENDOR_EXCLUDES"], T("TEXT_SECONDARY"))
        GameTooltip:Show()
    end)
    ...
    local consumablesBtn = ns.UI.CreateButton(nil, state.filtersDialog, ns.L["UI_VENDOR_CONSUMABLES_TITLE"], 176, 26)
    ...
    consumablesBtn:SetScript("OnEnter", function(self)
        ...
        self.text:SetTextColor(T("TEXT_ACCENT"))
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText(ns.L["UI_VENDOR_CONSUMABLES_TITLE"], T("TEXT_ACCENT"))
    ...
    local whiteBtn = ns.UI.CreateButton(nil, state.filtersDialog, ns.L["UI_VENDOR_WHITES_TITLE"], 176, 26)
    ...
    whiteBtn:SetScript("OnEnter", function(self)
        ...
        self.text:SetTextColor(T("TEXT_ACCENT"))
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText(ns.L["UI_VENDOR_WHITES_TITLE"], T("TEXT_ACCENT"))
    ...
    local clearAllBtn = ns.UI.CreateButton(nil, state.filtersDialog, ns.L["UI_VENDOR_CLEAR_TITLE"], 176, 26)
    ...
    clearAllBtn:SetScript("OnEnter", function(self)
        ...
        self.text:SetTextColor(T("TEXT_ACCENT"))
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText(ns.L["UI_VENDOR_CLEAR_TITLE"], T("TEXT_ACCENT"))
    ...
    ilvlLabel:SetTextColor(T("TEXT_PRIMARY"))
    yOffset = yOffset - 22
    ...
    ilvlEditBox:SetBackdrop(BACKDROP_INNER)
    ilvlEditBox:SetBackdropColor(T("BG_TERTIARY"))
    ilvlEditBox:SetBackdropBorderColor(T("BORDER_SUBTLE"))
    ...
    ilvlEditBox:SetTextInsets(S("SM"), S("SM"), 0, 0)
    ilvlEditBox:SetTextColor(T("TEXT_PRIMARY"))
    ...
    local ilvlBtn = ns.UI.CreateButton(nil, state.filtersDialog, "Add", 60, 26)
    ...
    excludeLabel:SetTextColor(T("TEXT_PRIMARY"))
    yOffset = yOffset - 26
    ...
    blizzLabel:SetTextColor(T("TEXT_PRIMARY"))

    showBlizzJunk:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText(ns.L["VENDOR_SHOW_BLIZZ_JUNK"], T("TEXT_ACCENT"))
    ...
    local neverSellBtn = ns.UI.CreateButton(nil, state.filtersDialog, "", 176, 26)
    ...
    neverSellBtn:SetScript("OnEnter", function(self)
        ...
        self.text:SetTextColor(T("TEXT_ACCENT"))
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText(ns.L["VENDOR_PROTECTED_ITEMS"], T("TEXT_ACCENT"))
...
function VendorPanel:CreateNeverSellDialog()
    ...
    state.neverSellDialog:SetBackdrop(BACKDROP_INNER)
    state.neverSellDialog:SetBackdropColor(T("BG_PRIMARY"))
    state.neverSellDialog:SetBackdropBorderColor(T("BORDER_DEFAULT"))
    ...
    local titleBar = CreateTitleBar(
        state.neverSellDialog,
        ns.L["VENDOR_PROTECTED_ITEMS"],
        function() state.neverSellDialog:Hide() end
    )
    ...
    scrollFrame:SetPoint("TOPLEFT", titleBar, "BOTTOMLEFT", S("SM"), -S("XS"))
    scrollFrame:SetPoint("BOTTOMRIGHT", state.neverSellDialog, "BOTTOMRIGHT", -S("SM"), 65)
    ...
    local closeDialogButton = ns.UI.CreateButton(nil, state.neverSellDialog, ns.L["VENDOR_CLOSE"], 100, 28)
...
function VendorPanel:UpdateNeverSellDialog()
    ...
    for itemID, itemLink in pairs(neverSellList) do
        ...
        itemFrame:SetBackdrop(BACKDROP_INNER)
        itemFrame:SetBackdropColor(T("BG_SECONDARY"))
        itemFrame:SetBackdropBorderColor(T("BORDER_SUBTLE"))
        ...
        iconFrame:SetBackdropBorderColor(T("BORDER_DEFAULT"))
...
function VendorPanel:CreateCategory(parent, items, yOffset, title, color, category, isMarkedJunk, isOneTime, isNoValueJunk)
    ...
    headerFrame:SetBackdrop(BACKDROP_INNER)
    ...
    if isOneTime then
        ...
        oneTimeLabel:SetTextColor(T("TEXT_ACCENT"))

        local clearBtn = ns.UI.CreateButton(nil, headerFrame, ns.L["VENDOR_CLEAR_ALL"], 60, 20)
    ...
    if isNoValueJunk then
        ...
        deleteAllBtn:SetBackdrop(BACKDROP_INNER)
        ...
        deleteAllBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine(" ", 1, 1, 1)
            GameTooltip:AddLine(ns.L["VENDOR_CTRL_PROTECT"], T("TEXT_SECONDARY"))
            GameTooltip:Show()
        end)
    ...
    if not state.collapsedCategories[category] then
        for _, item in ipairs(items) do
            ...
            highlight:SetColorTexture(T("BG_HOVER"))
            ...
            if item.noSellPrice then
                ...
                totalPriceBox:SetBackdrop(BACKDROP_INNER)
                ...
                totalPriceText:SetTextColor(T("TEXT_ACCENT"))
                ...
                totalPriceBox:SetPoint("RIGHT", itemFrame, "RIGHT", -4, 0)
                totalPriceBox:SetBackdrop(BACKDROP_INNER)
                totalPriceBox:SetBackdropColor(T("BG_TERTIARY"))
                totalPriceBox:SetBackdropBorderColor(T("BORDER_SUBTLE"))
            ...
            if item.stackCount > 1 and not item.noSellPrice then
                ...
                eaPriceText:SetTextColor(T("TEXT_SECONDARY"))
                ...
                eaPriceBox:SetBackdrop(BACKDROP_INNER)
                eaPriceBox:SetBackdropColor(T("BG_SECONDARY"))
                eaPriceBox:SetBackdropBorderColor(T("BORDER_DEFAULT"))
            ...
            itemFrame:SetScript("OnEnter", function(self)
                ...
                GameTooltip:AddLine(" ", 1, 1, 1)
                if not item.noSellPrice then GameTooltip:AddLine(ns.L["VENDOR_SHIFT_SELL"], T("TEXT_ACCENT")) end
                if isNoValueJunk then GameTooltip:AddLine(ns.L["VENDOR_MARK_PROTECTED"], T("TEXT_ACCENT"))
                elseif isOneTime then
                    GameTooltip:AddLine(ns.L["VENDOR_REMOVE_ONETIME"], T("TEXT_ACCENT"))
                    GameTooltip:AddLine(ns.L["VENDOR_MARK_PROTECTED"], T("TEXT_ACCENT"))
                elseif isMarkedJunk then
                    GameTooltip:AddLine(ns.L["VENDOR_REMOVE_JUNK"], 0, 1, 0)
                    GameTooltip:AddLine(ns.L["VENDOR_MARK_PROTECTED"], T("TEXT_ACCENT"))
                else GameTooltip:AddLine(ns.L["VENDOR_MARK_PROTECTED"], T("TEXT_ACCENT")) end
                GameTooltip:Show()
            end)
