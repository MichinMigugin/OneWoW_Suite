...
local BASE = "Interface\\AddOns\\" .. addonName .. "\\Libs\\OneWoW_GUI-1.0\\Media\\"
...
OneWoW_GUI.Constants = {
    ...
    -- The active theme is set by the addon and is used to style the UI
    ACTIVE_THEME = nil,

    -- The fallback theme is used when no theme is set
    FALLBACK_THEME = {
        ...
        -- These are the same for every theme
