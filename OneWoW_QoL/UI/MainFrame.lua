...
function ns.UI:CreateMainFrame(defaultTab)
    ...
    if factionTheme == "alliance" then
        brandIconTex = "Interface\\AddOns\\OneWoW_QoL\\Media\\alliance-mini.png"
    elseif factionTheme == "neutral" then
        brandIconTex = "Interface\\AddOns\\OneWoW_QoL\\Media\\neutral-mini.png"
    else
        brandIconTex = "Interface\\AddOns\\OneWoW_QoL\\Media\\horde-mini.png"
    end
