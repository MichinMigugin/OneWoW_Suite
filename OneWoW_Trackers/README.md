...
### Auto-Tracking
- Many step types auto-complete from game events: quests, renown, vault slots, professions, transmog, kills/loot, coordinates, exploration, custom timers, and more. Open-world rares use Kill a Rare or Boss; dungeon and raid bosses use Kill a Dungeon or Raid Boss (fill during the fight or just after). Rare Quest tracks the hidden loot lock: fill from target, search by name, or use the Midnight Zone Rares preset.
