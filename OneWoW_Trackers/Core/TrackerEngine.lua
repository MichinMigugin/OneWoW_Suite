...
function TE:GetTrackTypeDisplayName(trackType)
    ...
    local names = {
        ...
        quest_world     = L["TRACKER_TYPE_QUEST_WORLD"],
        level           = L["TRACKER_TYPE_LEVEL"],
        item            = L["TRACKER_TYPE_ITEM"],
        currency        = L["TRACKER_TYPE_CURRENCY"],
        achievement     = L["TRACKER_TYPE_ACHIEVEMENT"],
        reputation      = L["TRACKER_TYPE_REPUTATION"],
        renown          = L["TRACKER_TYPE_RENOWN"],
        spell_known     = L["TRACKER_TYPE_SPELL_KNOWN"],
        ilvl            = L["TRACKER_TYPE_ILVL"],
        location        = L["TRACKER_TYPE_LOCATION"],
        ...
        toy             = L["TRACKER_TYPE_TOY"],
        mount           = L["TRACKER_TYPE_MOUNT"],
        pet             = L["TRACKER_TYPE_PET"],
...
function TE:GetListTypeDisplayName(listType)
    local L = ns.L
    local names = {
        guide     = L["TRACKER_LIST_GUIDE"],
        daily     = L["TRACKER_LIST_DAILY"],
        weekly    = L["TRACKER_LIST_WEEKLY"],
