...
local CATEGORY_RULES = {
    ...
    upgrade = { upgrade = true, upgradeable = true, fullyupgraded = true, upgradetrack = true, currentseason = true, activeseason = true, explorer = true, adventurer = true, veteran = true, champion = true, hero = true, myth = true },
