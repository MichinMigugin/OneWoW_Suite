...
function Nested:CreateDungeonsButton(parent, iconSize, yOffset, expansions, showAll)
	...
	mainButton:SetNormalTexture("Interface\\Icons\\Achievement_Boss_Archaedas")

	mainButton.text = mainButton:CreateFontString(nil, "OVERLAY")
	mainButton.text:SetPoint("BOTTOM", mainButton, "BOTTOM", 0, 2)
	mainButton.text:SetFont(STANDARD_TEXT_FONT, 8, "OUTLINE")
	mainButton.text:SetTextColor(1, 1, 1, 1)
	mainButton.text:SetShadowColor(0, 0, 0, 1)
	mainButton.text:SetShadowOffset(1, -1)
	mainButton.text:SetText(L["SETTINGS_PORTALHUB_DUNGEONS"])
	...
	for i, expData in ipairs(validExpansions) do
		...
		expButton.text = expButton:CreateFontString(nil, "OVERLAY")
		expButton.text:SetPoint("BOTTOM", expButton, "BOTTOM", 0, 2)
		expButton.text:SetFont(STANDARD_TEXT_FONT, 8, "OUTLINE")
		expButton.text:SetTextColor(1, 1, 1, 1)
	...
	mainButton:SetScript("OnEnter", function(self)
		...
		GameTooltip:SetText(L["SETTINGS_PORTALHUB_DUNGEONS"], 1, 1, 1)
		GameTooltip:Show()
	end)
...
function Nested:CreateRaidsButton(parent, iconSize, yOffset, expansions, showAll)
	...
	mainButton:SetSize(iconSize, iconSize)
	mainButton:SetPoint("TOPLEFT", parent, "TOPLEFT", 0, yOffset)
	mainButton:SetNormalTexture(4062765)
	...
	mainButton.text:SetShadowColor(0, 0, 0, 1)
	mainButton.text:SetShadowOffset(1, -1)
	mainButton.text:SetText(L["SETTINGS_PORTALHUB_RAIDS"])
	...
	mainButton:SetScript("OnEnter", function(self)
		expFlyout:Show()
		GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
		GameTooltip:SetText(L["SETTINGS_PORTALHUB_RAIDS"], 1, 1, 1)
		GameTooltip:Show()
	end)
