...
function ns.UI.CreateEquipmentTab(parent)
    local overview = OneWoW_GUI:CreateOverviewPanel(parent, {
        ...
        columns = 5,
        stats = {
            {label = L["ATTENTION"],       value = "0", ttTitle = L["ATTENTION"],       ttDesc = L["TT_EQUIPMENT_ATTENTION_DESC"]},
            {label = L["CHARACTERS"],      value = "0", ttTitle = L["CHARACTERS"],      ttDesc = L["TT_EQUIPMENT_CHARACTERS_DESC"]},
            {label = L["PROGRESS_AVG_ILVL"],        value = "0", ttTitle = L["TT_EQUIPMENT_AVG_ILVL"],        ttDesc = L["TT_EQUIPMENT_AVG_ILVL_DESC"]},
            {label = L["EQUIPMENT_HIGHEST_ILVL"],    value = "0", ttTitle = L["EQUIPMENT_HIGHEST_ILVL"],    ttDesc = L["TT_EQUIPMENT_HIGHEST_ILVL_DESC"]},
            {label = L["EQUIPMENT_LOWEST_ILVL"],     value = "0", ttTitle = L["EQUIPMENT_LOWEST_ILVL"],     ttDesc = L["TT_EQUIPMENT_LOWEST_ILVL_DESC"]},
            {label = L["EQUIPMENT_MISSING_ENCHANTS"], value = "0", ttTitle = L["EQUIPMENT_MISSING_ENCHANTS"], ttDesc = L["TT_EQUIPMENT_MISSING_ENCHANTS_DESC"]},
            {label = L["EQUIPMENT_MISSING_GEMS"],    value = "0", ttTitle = L["EQUIPMENT_MISSING_GEMS"],    ttDesc = L["TT_EQUIPMENT_MISSING_GEMS_DESC"]},
            {label = L["EQUIPMENT_LOW_DURABILITY"],  value = "0", ttTitle = L["EQUIPMENT_LOW_DURABILITY"],  ttDesc = L["TT_EQUIPMENT_LOW_DURABILITY_DESC"]},
            {label = L["EQUIPMENT_SET_BONUSES"],     value = "0", ttTitle = L["EQUIPMENT_SET_BONUSES"],     ttDesc = L["TT_EQUIPMENT_SET_BONUSES_DESC"]},
        },
    })
    ...
    local columnsConfig = {
        ...
        {key = "haste",     label = L["TT_COL_HASTE"],    width = 50,  fixed = true,  align = "center",                   ttTitle = L["TT_COL_HASTE"],            ttDesc = L["TT_COL_HASTE_DESC"]},
