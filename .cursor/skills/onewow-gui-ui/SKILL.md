...
- **Status / features:** `TEXT_FEATURES_ENABLED/DISABLED`, `DOT_FEATURES_ENABLED/DISABLED`, `BG_FEATURES_ENABLED` / `BG_FEATURES_ENABLED_HOVER` (soft On fill for single-state toggles)
