...
local function CreateListRow(parent)
    ...
    row.countText:SetTextColor(T("TEXT_SECONDARY"))
    ...
    row.selectedBar:SetColorTexture(T("ACCENT_PRIMARY"))
...
local function ConfigureListRow(row, listName, isSelected, isDefault, childCount, craftOrderCount)
    ...
    if isSelected then
        ...
        row.nameText:SetTextColor(T("TEXT_ACCENT"))
    else
        row:SetBackdropColor(T("BG_TERTIARY"))
        row:SetBackdropBorderColor(T("BORDER_SUBTLE"))
        row.selectedBar:Hide()
    ...
    if list and list.isCraftOrder then
        row.nameText:SetTextColor(T("ACCENT_MUTED"))
    end
end
...
function MainWindow:Create()
    ...
    mainFrame:SetBackdropColor(T("BG_PRIMARY"))
    mainFrame:SetBackdropBorderColor(T("BORDER_DEFAULT"))
    mainFrame:Hide()
    ...
    settingsToggleBtn:SetBackdropColor(T("BTN_NORMAL"))
    settingsToggleBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    settingsBtnLabel:SetTextColor(T("TEXT_PRIMARY"))
    settingsToggleBtn:SetScript("OnEnter", function(self)
        self:SetBackdropColor(T("BTN_HOVER"))
        settingsBtnLabel:SetTextColor(T("TEXT_ACCENT"))
    ...
    sidebarHeader:SetBackdropColor(T("BG_SECONDARY"))
    sidebarHeader:SetBackdropBorderColor(T("BORDER_SUBTLE"))
    ...
    sidebarTitle:SetTextColor(T("ACCENT_PRIMARY"))
    ...
    newListBtn:SetBackdropColor(T("BTN_NORMAL"))
    newListBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    newListBtn.text:SetTextColor(T("TEXT_PRIMARY"))
    ...
    contentHeader:SetBackdropColor(T("BG_SECONDARY"))
    contentHeader:SetBackdropBorderColor(T("BORDER_SUBTLE"))
    ...
    currentListLabel:SetTextColor(T("TEXT_ACCENT"))
    ...
    importBtn:SetBackdropColor(T("BTN_NORMAL"))
    importBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    importBtn.text:SetTextColor(T("TEXT_PRIMARY"))
    importBtn:SetScript("OnEnter", function(self) self:SetBackdropColor(T("BTN_HOVER")) self.text:SetTextColor(T("TEXT_ACCENT")) end)
    importBtn:SetScript("OnLeave", function(self) self:SetBackdropColor(T("BTN_NORMAL")) self.text:SetTextColor(T("TEXT_PRIMARY")) end)
    ...
    scanBtn:SetBackdropColor(T("BTN_NORMAL"))
    scanBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    scanBtn.text:SetTextColor(T("TEXT_PRIMARY"))
    ...
    altLabel:SetTextColor(T("TEXT_SECONDARY"))
    ...
    addButtonRow:SetBackdropColor(T("BG_SECONDARY"))
    addButtonRow:SetBackdropBorderColor(T("BORDER_SUBTLE"))
    ...
    statusLabel:SetTextColor(T("TEXT_MUTED"))
    ...
    dragBtn:SetBackdropColor(T("BTN_NORMAL"))
    dragBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    dragBtn.text:SetTextColor(T("TEXT_PRIMARY"))
    ...
    addByIdBtn:SetBackdropColor(T("BTN_NORMAL"))
    addByIdBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    addByIdBtn.text:SetTextColor(T("TEXT_PRIMARY"))
    addByIdBtn:SetScript("OnEnter", function(self) self:SetBackdropColor(T("BTN_HOVER")) self.text:SetTextColor(T("TEXT_ACCENT")) end)
    addByIdBtn:SetScript("OnLeave", function(self) self:SetBackdropColor(T("BTN_NORMAL")) self.text:SetTextColor(T("TEXT_PRIMARY")) end)
...
function MainWindow:BuildSettingsPanel()
    ...
    settingsPanel:SetBackdropColor(T("BG_PRIMARY"))
    settingsPanel:SetBackdropBorderColor(T("BORDER_DEFAULT"))
    settingsPanel:Hide()
    ...
    settingsTitle:SetTextColor(T("ACCENT_PRIMARY"))
    yOff = yOff - 28
    ...
    backBtn:SetBackdropColor(T("BTN_NORMAL"))
    backBtn:SetBackdropBorderColor(T("BTN_BORDER"))
    ...
    backBtn.text:SetTextColor(T("TEXT_PRIMARY"))
    backBtn:SetScript("OnEnter", function(self) self:SetBackdropColor(T("BTN_HOVER")) self.text:SetTextColor(T("TEXT_ACCENT")) end)
    backBtn:SetScript("OnLeave", function(self) self:SetBackdropColor(T("BTN_NORMAL")) self.text:SetTextColor(T("TEXT_PRIMARY")) end)
    ...
    local function CreateLangMenu()
        ...
        langMenu:SetBackdrop({ bgFile = "Interface\\Buttons\\WHITE8X8", edgeFile = "Interface\\Tooltips\\UI-Tooltip-Border",
            tile = false, edgeSize = 12, insets = { left = 2, right = 2, top = 2, bottom = 2 } })
    ...
    local function CreateThemeMenu()
        ...
        themeMenu:SetBackdrop({ bgFile = "Interface\\Buttons\\WHITE8X8", edgeFile = "Interface\\Tooltips\\UI-Tooltip-Border",
            tile = false, edgeSize = 12, insets = { left = 2, right = 2, top = 2, bottom = 2 } })
    ...
    tooltipLabel:SetTextColor(T("TEXT_PRIMARY"))
    local db = GetDB()
    ...
    dividerTex:SetColorTexture(T("BORDER_SUBTLE"))
    yOff = yOff - 16
    ...
    overlayLabel:SetTextColor(T("TEXT_PRIMARY"))
    ...
    bagBtnCbLabel:SetTextColor(T("TEXT_PRIMARY"))
    ...
    profBtnCbLabel:SetTextColor(T("TEXT_PRIMARY"))
    ...
    ahBtnCbLabel:SetTextColor(T("TEXT_PRIMARY"))
    ...
    local function AddKeybindRow(labelText, bindingName, y)
        ...
        if binding then
            bVal:SetTextColor(T("TEXT_ACCENT"))
        else
            bVal:SetTextColor(T("TEXT_MUTED"))
        end
    end
    ...
    bindInfoLabel:SetTextColor(T("TEXT_MUTED"))
...
function MainWindow:RefreshItemList()
    ...
    for _, itemData in ipairs(items) do
        ...
        qtyBox:SetBackdropColor(T("BG_TERTIARY"))
        qtyBox:SetBackdropBorderColor(T("BORDER_SUBTLE"))
        ...
        if itemData.isUnresolved then
            ...
            idLabel:SetTextColor(T("TEXT_MUTED"))
            ...
            idBox:SetBackdropColor(T("BG_TERTIARY"))
            ...
            if #locations > 0 then
                statusBtn:SetScript("OnEnter", function(self)
                    row:SetBackdropColor(T("BG_HOVER"))
                    GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
            ...
            local function ToggleExpanded()
                ...
                if row.isExpanded then
                    if not row.expandedFrame then
                        ...
                        row.expandedFrame:SetBackdrop({ bgFile = "Interface\\Buttons\\WHITE8x8" })
                        row.expandedFrame:SetBackdropColor(T("BG_SECONDARY"))
            ...
            if itemData.isCraftable then
                ...
                craftLabel:SetTextColor(T("TEXT_PRIMARY"))
        ...
        row:SetScript("OnLeave", function(self) self:SetBackdropColor(T("BG_TERTIARY")) end)
