...
OneWoW_ShoppingList.Constants = {
    VERSION = "R6.2602.2100",
    ADDON_NAME = "OneWoW_ShoppingList",
...
OneWoW_ShoppingList.THEME   = OneWoW_ShoppingList.Constants.THEME
OneWoW_ShoppingList.SPACING = OneWoW_ShoppingList.Constants.SPACING
